...
// ✅ Dynamically import ESM build to avoid Next.js strict export error
const Spline = dynamic(() => import("@splinetool/react-spline/esm"), {
  ssr: false,
  loading: () => (
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "You can enroll by visiting our Registration form and filling it out, or call us directly at +91-9970616339.",
  },
  {
...
export default function FAQPage() {
  ...
  return (
    <div className="relative flex flex-col md:flex-row w-screen min-h-screen overflow-hidden">
      {/* ✅ FAQ Section */}
      <section className="relative z-10 w-full md:w-1/2 pt-32 sm:pt-40 md:pt-16 px-6 sm:px-8 md:px-16">
        ...
        <div className="space-y-4">
          {faqs.map((faq, index) => (
            ...
            >
              ...
              {openIndex === index && (
                <div className="font-crimson px-4 pb-4 text-gray-700">
                  {faq.answer}
                </div>
              )}
            </div>
